...
${drop}           xpath=//android.widget.EditText[@resource-id="text_input"]
...
${option}         xpath=//android.widget.CheckedTextView[@resource-id="android:id/text1" and @text="webdriver.io is awesome"]
...
Interação com chave Switch - ON
    ...
    Element Text Should Be    ${val_switch}    Click to turn the switch ON
